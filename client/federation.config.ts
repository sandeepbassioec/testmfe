  ...
  teams: [
    {
      ...
      manifestUrl: 'http://localhost:8080/manifests/team-a-manifest.json',
      priority: 1,
      timeout: 15000,
      retries: 5,
    ...
    },
    {
      ...
      manifestUrl: 'http://localhost:8080/manifests/team-b-manifest.json',
      priority: 2,
      timeout: 15000,
      retries: 5,
      healthCheckUrl: 'http://localhost:8080/health',
    ...
    },
    {
      ...
      manifestUrl: 'http://localhost:8080/manifests/team-c-manifest.json',
      priority: 3,
      timeout: 15000,
      retries: 5,
      healthCheckUrl: 'http://localhost:8080/health',
